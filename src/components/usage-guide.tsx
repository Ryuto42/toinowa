...
const steps: Record<Role, Step[]> = {
  teacher: [
    ...
    {
      title: '4. 提出ごとの分析を開く',
      body: '「提出ごとの分析」から1件を選ぶと、観点別の内訳（概念の定義・論理のつながり・具体例・正確さ・伝わりやすさ）、できていたこと、次に確認したいことが開きます。AIが根拠にできた情報が少ないときは「確認が必要」と表示されます。根拠を読んで納得できれば「この内容で上書きする」から点数と修正理由を残せます。',
      image: 'teacher-analysis',
      caption: '確信度が低い評価は、必ずこの画面で根拠を確認してから生徒への反映を判断してください。',
    },
    {
      title: '5. 気になる生徒に気づく',
  ...
  student: [
    ...
    },
    {
      ...
      image: 'student-talk',
      caption: 'AIは答えを知らないふりをして聞き返します。会話は自動で下にスクロールし、入力欄は常に画面下に残ります。',
    },
    {
