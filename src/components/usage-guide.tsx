...
const steps: Record<Role, Step[]> = {
  teacher: [
    {
      title: '1. 授業で教えたことを渡す',
      body: '「授業と宿題」の右上「新しく作成」を押します。渡す相手（生徒ごと／クラス一括）と期限を選び、授業メモを書くか、授業資料のPDF・写真を選びます。両方でも大丈夫です。「AIに準備を任せる」を押すと、対象の生徒それぞれに課題と学習計画を準備します。上のステップ表示が2に進んだら受付完了です。画面を閉じても準備は続きます。',
      href: '/teacher/assignments', action: '授業と宿題を開く',
    ...
    },
    {
      ...
      body: '生徒が対話を終えると、AIが説明を分析します。「生徒」から対象の生徒を開くと、理解度・観点別の強み弱み・繰り返すつまずき・提出ごとの根拠が見られます。次回の課題案も自動で準備されますが、配信するかどうかは先生が決めます。',
  ...
  student: [
    ...
    {
      title: '1. 今日のお題を開く',
      body: '「AIワーク」で課題を開きます。未着手・進行中・完了が一目で分かります。何を説明するかと期限を確認してから始めましょう。',
      href: '/student/study', action: 'AIワークを開く',
      image: 'student-study',
    },
    {
      title: '2. AIに、自分の言葉で教える',
      body: 'AIは、あなたの説明を聞く相手です。用語の意味、なぜそうなるか、身近な例を使って説明してみましょう。AIから質問されたら、言い直したり例を変えたりして大丈夫です。わからないときは「ここがわからない」と伝えてください。送信を間違えたときは「↩ 直前の送信を取り消す」で1つ前に戻せます。',
    },
    {
  ...
  admin: [
    ...
    },
    {
      ...
      body: 'AI利用状況では、モデルの稼働・本日の予算・利用者別の費用を確認できます。モデルの一時停止もここから行えます。一時停止すると次の呼び出しから代替モデルへ切り替わり、学習は止まりません。',
