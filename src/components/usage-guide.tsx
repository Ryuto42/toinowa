...
const steps: Record<Role, Step[]> = {
  ...
  student: [
    ...
    },
    {
      ...
      body: 'AIは、あなたの説明を聞く相手です。用語の意味、なぜそうなるか、身近な例を使って説明してみましょう。AIから質問されたら、言い直したり例を変えたりして大丈夫です。わからないときは「ここがわからない」と伝えてください。書くより話すほうが説明しやすいときは、入力欄の右にある緑のマイクを押すと、話した内容がその場で会話に書き起こされます。もう一度押すと止まります。送信を間違えたときは「↩ 直前の送信を取り消す」で1つ前に戻せます。',
    },
    {
...
const questions: Record<Role, Array<[string, string]>> = {
  ...
  student: [
    ...
    ['声で説明できますか？', '入力欄の右にある緑のマイクを押すと録音が始まり、話した内容がその場で会話に書き起こされます。もう一度押すと終わります。うまく聞き取れないときは、静かな場所で少しゆっくり話してみてください。'],
