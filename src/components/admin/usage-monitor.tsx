...
interface Usage { budget: { limitUsd: number; spentUsd: number }; unpricedRuns: number; grouped: ReturnType<typeof summarizeUsage>; summary: { requests: number; costUsd: number; tokens: number }; truncated: boolean; updatedAt: string }
