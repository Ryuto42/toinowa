...
export function generateInitialPassword() { return `${randomBytes(12).toString('base64url')}Aa1!`; }
export function generateStudentCredentials() {
  return { initialPassword: generateInitialPassword(), authEmail: `student-${randomUUID()}@students.invalid` };
}
