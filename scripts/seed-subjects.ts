...
/**
 * お題は「手元に資料がなくても、授業で習ったことだけで口で説明しきれる」ものにする。
 *
 * 「本文の筆者の主張を」「資料から読み取れる」のように資料を前提にすると、
 * 生徒は書き写すだけになり、自分の言葉で教える練習にならない。
 * 「主張と根拠とは何か」のような読み方の話も、授業で習った覚えと結びつかず答えにくい。
 * 数学の「傾きと切片」と同じで、教科の中身そのものを説明させる。
 */
const subjects = [
  {
    subject: '国語', classroom: '国語1-A', lesson: '古文入門', concept: '係り結びの法則',
    question: '古文の「係り結び」とはどういう決まりなのか、私に教えてください。「ぞ・なむ・や・か・こそ」から二つ選び、それぞれ文末がどう変わるのかを短い例文で示してください。なぜこんな決まりがあるのだと思うかも聞かせてください。',
  },
  {
    subject: '英語', classroom: '英語1-A', lesson: '時制のしくみ', concept: '現在完了と過去形のちがい',
    question: '英語の現在完了形（have + 過去分詞）が、過去形とどう違うのか、私に教えてください。同じ出来事を二つの形で言い分けた例を一つ作り、聞き手の受け取り方がどう変わるのかも説明してください。',
  },
  {
    subject: '理科', classroom: '理科1-A', lesson: '細胞のつくり', concept: '植物細胞と動物細胞のちがい',
    question: '植物の細胞と動物の細胞は何が違うのか、私に教えてください。植物だけが持つつくりを二つ挙げ、それぞれが植物にとってどう役立っているのかも説明してください。',
  },
  {
    subject: '社会', classroom: '日本の地理', lesson: '地形のなりたち', concept: '扇状地と三角州',
    question: '扇状地と三角州は、川のどのあたりに、どうやってできるのか、私に教えてください。二つの違いを「川の流れの速さ」と「運ばれる土砂の粒の大きさ」から説明し、それぞれの土地が何に使われやすいかにも触れてください。',
  },
] as const;
